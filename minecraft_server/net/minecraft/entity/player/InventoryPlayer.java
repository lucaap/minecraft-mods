...
public class InventoryPlayer implements IInventory
{
    ...
    @SideOnly(Side.CLIENT)
    private int func_70434_c(int par1, int par2)
    {
    ...
    public void func_70433_a(int par1, int par2, boolean par3, boolean par4)
    {
        ...
        if (par3)
        {
            var7 = this.func_70434_c(par1, par2);
        }
        else
        {
    ...
    @SideOnly(Side.CLIENT)
    public void func_70453_c(int par1)
    {
        if (par1 > 0)
        {
            par1 = 1;
    ...
    public void func_70439_a(Item par1Item, int par2)
    {
        if (par1Item != null)
        {
            if (this.field_70456_f != null && this.field_70456_f.isItemEnchantable() && this.func_70434_c(this.field_70456_f.itemID, this.field_70456_f.getItemDamageForDisplay()) == this.currentItem)
            {
                return;
            }

            int var3 = this.func_70434_c(par1Item.itemID, par2);
