...
public abstract class BlockRedstoneLogic extends BlockDirectional
{
    ...
    {
        return par1 == 0 ? (this.isRepeaterPowered ? Block.torchRedstoneActive.func_71851_a(par1) : Block.torchRedstoneIdle.func_71851_a(par1)) : (par1 == 1 ? this.field_94336_cN : Block.stoneDoubleSlab.func_71851_a(1));
    }
