...
public abstract class BlockHalfSlab extends Block
{
    ...
    public boolean func_71877_c(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        else if (par5 != 1 && par5 != 0 && !super.func_71877_c(par1IBlockAccess, par2, par3, par4, par5))
        {
            return false;
        }
        else
        {
            ...
            return var9 ? (par5 == 0 ? true : (par5 == 1 && super.func_71877_c(par1IBlockAccess, par2, par3, par4, par5) ? true : !func_72241_e(par1IBlockAccess.getBlockId(par2, par3, par4)) || (par1IBlockAccess.getBlockMetadata(par2, par3, par4) & 8) == 0)) : (par5 == 1 ? true : (par5 == 0 && super.func_71877_c(par1IBlockAccess, par2, par3, par4, par5) ? true : !func_72241_e(par1IBlockAccess.getBlockId(par2, par3, par4)) || (par1IBlockAccess.getBlockMetadata(par2, par3, par4) & 8) != 0));
        }
    }
    ...
    {
        return func_72241_e(this.blockID) ? this.blockID : (this.blockID == Block.stoneDoubleSlab.blockID ? Block.stoneSingleSlab.blockID : (this.blockID == Block.woodDoubleSlab.blockID ? Block.woodSingleSlab.blockID : Block.stoneSingleSlab.blockID));
    }
}
