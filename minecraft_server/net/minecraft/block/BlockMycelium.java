...
public class BlockMycelium extends Block
{
    ...
    {
        return par1 == 1 ? this.field_94422_a : (par1 == 0 ? Block.dirt.func_71851_a(par1) : this.field_94336_cN);
    }
    ...
    public Icon func_71895_b(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            return var6 != Material.snow && var6 != Material.craftedSnow ? this.field_94336_cN : this.field_94421_b;
        }
    }
    ...
    public void func_94332_a(IconRegister par1IconRegister)
    {
        ...
        this.field_94422_a = par1IconRegister.func_94245_a(this.func_111023_E() + "_top");
        this.field_94421_b = par1IconRegister.func_94245_a("grass_side_snowed");
    }
