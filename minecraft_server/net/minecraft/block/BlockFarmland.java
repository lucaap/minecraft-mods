...
public class BlockFarmland extends Block
{
    ...
    {
        return par1 == 1 ? (par2 > 0 ? this.field_94441_a : this.field_94440_b) : Block.dirt.func_71851_a(par1);
    }
    ...
    {
        this.field_94441_a = par1IconRegister.func_94245_a(this.func_111023_E() + "_wet");
        this.field_94440_b = par1IconRegister.func_94245_a(this.func_111023_E() + "_dry");
    }
}
