...
public class BlockStem extends BlockFlower
{
    ...
    {
        return this.func_71889_f_(par1IBlockAccess.getBlockMetadata(par2, par3, par4));
    }
    ...
    @SideOnly(Side.CLIENT)
    public int func_72265_d(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
    ...
    {
        this.field_94336_cN = par1IconRegister.func_94245_a(this.func_111023_E() + "_disconnected");
        this.field_94369_b = par1IconRegister.func_94245_a(this.func_111023_E() + "_connected");
    }
